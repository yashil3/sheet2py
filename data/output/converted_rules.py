...
def rule_formulas_e3(data, shared_data):
    ...
    Dependencies: Source!I3, Source!H3, Source!G3, Source!B20
    """
    try:
...
def rule_formulas_e6(data, shared_data):
    ...
    Dependencies: Source!I6, Source!H6, Source!J6, Source!B8, Source!B9, Source!B10, Source!G6
    """
    try:
...
def rule_formulas_e9(data, shared_data):
    ...
    Cell: Formulas!E9
    Rule type: scoring_rule
    Dependencies: Source!G11, Source!B16, Source!G12, Source!G9, Source!B17, Source!G10, Source!B19, Source!B15
    """
    try:
...
def rule_formulas_e10(data, shared_data):
    ...
    Cell: Formulas!E10
    Rule type: general_calculation
    Dependencies: Formulas!E3, Formulas!C6, Formulas!C9, Formulas!E7, Formulas!C5, Formulas!C3, Formulas!C2, Formulas!E5, Formulas!E4, Formulas!C4, Formulas!E6, Formulas!E8, Formulas!E9, Formulas!C8, Formulas!E2, Formulas!C7
    """
    try:
