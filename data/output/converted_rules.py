...
def rule_formulas_e2(data, shared_data):
    ...
    """
    try:
        result = safe_execute(lambda: ((1 if (find_text(get_cell(self.data, 'Source', 'G2'), get_cell(self.data, 'Source', 'B14')) > 0) else 0)), 0)
        return result
...
def rule_formulas_e3(data, shared_data):
    ...
    Dependencies: Source!G3, Source!B20, Source!H3, Source!I3
    """
    try:
        result = ((1 if ((get_cell(self.data, 'Source', 'G3') == get_cell(self.data, 'Source', 'B20')) or (get_cell(self.data, 'Source', 'H3') == get_cell(self.data, 'Source', 'B20')) or (get_cell(self.data, 'Source', 'I3') == get_cell(self.data, 'Source', 'B20'))) else 0))
        return result
    except Exception as e:
...
def rule_formulas_e4(data, shared_data):
    ...
    """
    try:
        result = (1 if (get_cell(self.data, 'Source', 'B5') <= 60000) else 0)
        return result
    except Exception as e:
...
def rule_formulas_e5(data, shared_data):
    ...
    """
    try:
        result = (1 if (get_cell(self.data, 'Source', 'B6') >= 2015) else 0)
        return result
    except Exception as e:
...
def rule_formulas_e6(data, shared_data):
    ...
    Dependencies: Source!G6, Source!H6, Source!B8, Source!B9, Source!B10, Source!I6, Source!J6
    """
    try:
        result = (((((count_if(self.data, 'Source', 'B8', 'B10', get_cell(self.data, 'Source', 'G6')) + count_if(self.data, 'Source', 'B8', 'B10', get_cell(self.data, 'Source', 'H6'))) + count_if(self.data, 'Source', 'B8', 'B10', get_cell(self.data, 'Source', 'I6'))) + count_if(self.data, 'Source', 'B8', 'B10', get_cell(self.data, 'Source', 'J6')))) / 4)
        return result
    except Exception as e:
...
def rule_formulas_e7(data, shared_data):
    ...
    """
    try:
        result = ((1 if ((get_cell(self.data, 'Source', 'B12') == "6-cylinder") or (get_cell(self.data, 'Source', 'B12') == "8-cylinder")) else 0))
        return result
    except Exception as e:
...
def rule_formulas_e8(data, shared_data):
    ...
    """
    try:
        result = (1 if (get_cell(self.data, 'Source', 'G8') == get_cell(self.data, 'Source', 'B13')) else 0)
        return result
    except Exception as e:
...
def rule_formulas_e9(data, shared_data):
    ...
    Cell: Formulas!E9
    Rule type: scoring_rule
    Dependencies: Source!B19, Source!G11, Source!B17, Source!G10, Source!G12, Source!G9, Source!B16, Source!B15
    """
    try:
        result = ((((((1 if ((get_cell(self.data, 'Source', 'G9') == "Auto-dimming Mirrors") and (get_cell(self.data, 'Source', 'B16') == "YES")) else 0) + (1 if ((get_cell(self.data, 'Source', 'G10') == "Heated seats") and (get_cell(self.data, 'Source', 'B15') == "YES")) else 0)) + (1 if ((get_cell(self.data, 'Source', 'G11') == "Leather Seats") and (get_cell(self.data, 'Source', 'B19') == "YES")) else 0)) + (1 if ((get_cell(self.data, 'Source', 'G12') == "Auto Wipers") and (get_cell(self.data, 'Source', 'B17') == "YES")) else 0))) / rows_count('G9', 'G12'))
        return result
    except Exception as e:
...
def rule_formulas_b10(data, shared_data):
    ...
    """
    try:
        result = sum_range(self.data, 'Formulas', 'B2', 'B9')
        return result
    except Exception as e:
...
def rule_formulas_c10(data, shared_data):
    ...
    """
    try:
        result = sum_range(self.data, 'Formulas', 'C2', 'C9')
        return result
    except Exception as e:
...
def rule_formulas_e10(data, shared_data):
    ...
    Cell: Formulas!E10
    Rule type: general_calculation
    Dependencies: Formulas!E9, Formulas!C6, Formulas!C4, Formulas!E4, Formulas!E5, Formulas!C8, Formulas!C2, Formulas!C7, Formulas!E7, Formulas!C3, Formulas!E2, Formulas!C5, Formulas!E6, Formulas!C9, Formulas!E3, Formulas!E8
    """
    try:
        result = (((((((((((((((get_cell(self.data, 'Formulas', 'E2') * get_cell(self.data, 'Formulas', 'C2')) + get_cell(self.data, 'Formulas', 'E3')) * get_cell(self.data, 'Formulas', 'C3')) + get_cell(self.data, 'Formulas', 'E4')) * get_cell(self.data, 'Formulas', 'C4')) + get_cell(self.data, 'Formulas', 'E5')) * get_cell(self.data, 'Formulas', 'C5')) + get_cell(self.data, 'Formulas', 'E6')) * get_cell(self.data, 'Formulas', 'C6')) + get_cell(self.data, 'Formulas', 'E7')) * get_cell(self.data, 'Formulas', 'C7')) + get_cell(self.data, 'Formulas', 'E8')) * get_cell(self.data, 'Formulas', 'C8')) + get_cell(self.data, 'Formulas', 'E9')) * get_cell(self.data, 'Formulas', 'C9'))
        return result
    except Exception as e:
